...
var margin = {top: 40, right: 50, bottom: 60, left: 50},
    width = document.getElementById("distance_chart").getBoundingClientRect().width - margin.left - margin.right,
    height = 850 - margin.top - margin.bottom;

// append the svg object to the body of the page
var svg = d3.select("#distance_chart")
  .append("svg")
...
var tooltip_bar = d3.select("#distance_chart")
  .append("div")
    .style("opacity", 0)
    .attr("class", "tooltip")
...
var showTooltip = function(d) {
  ...
  tooltip_bar
    .style("opacity", 1)
    .html("Condition: " + d.condition + "<br>" + "Distance: " + d.distance + "<br>" + "Hazard: " + d.hazard + "<br>" + "Observations: " + d.num_observations )
